...
export default function Splash() {
  ...
  return (
    <div style={{position:'fixed', inset:0, zIndex:9999, overflow:'hidden', background:'#0C1E3C'}}>
      ...
      {/* Overlay navy para legibilidad, mismo gradiente que antes */}
      <div style={{
        position:'absolute', inset:0,
        background:'linear-gradient(160deg, rgba(12,30,60,0.55) 0%, rgba(22,41,77,0.7) 60%, rgba(10,22,40,0.92) 100%)',
      }}/>
      ...
      <div style={{position:'absolute', inset:0, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', gap:'20px'}}>
        ...
        <h1 style={{
          ...
          transition:'all 0.7s ease 0.2s', textShadow:'0 2px 20px rgba(0,0,0,0.4)',
        }}>
          FUNEMOVE
        </h1>
